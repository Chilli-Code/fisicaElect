import{S as e}from"./main.mobile-B9PiUoMa.js";const t="bonesDeclaration",l=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=l);const r="bakedVertexAnimationDeclaration",c=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=c);const i="clipPlaneVertexDeclaration",I=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=I);const n="fogVertexDeclaration",E=`#ifdef FOG
varying vFogDistance: vec3f;
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=E);const f="instancesDeclaration",x=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=x);const a="instancesVertex",S=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=S);const s="bonesVertex",N=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=N);const d="bakedVertexAnimation",v=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=v);const o="clipPlaneVertex",p=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=p);const m="fogVertex",A=`#ifdef FOG
#ifdef SCENE_UBO
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=A);const u="vertexColorMixing",T=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
...
//# sourceMappingURL=vertexColorMixing-Bda_TF4A.js.map
