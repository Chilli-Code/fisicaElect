import{S as e}from"./main.mobile-B9PiUoMa.js";import"./mainUVVaryingDeclaration-1uLWd6eo.js";import"./helperFunctions-uxqIwNTp.js";import"./index-j5_oiMNG.js";const t="decalFragmentDeclaration",A=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=A);const o="defaultFragmentDeclaration",w=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=w);const r="prePassDeclaration",x=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=x);const a="oitDeclaration",P=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=X);const l="lightUboDeclaration",R=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=F);const s="clusteredLightingFunctions",N=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=N);const d="lightsFragmentFunctions",M=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=M);const c="shadowsFragmentFunctions",O=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=O);const h="samplerFragmentDeclaration",_=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=_);const v="fresnelFunction",y=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=y);const u="reflectionFunction",b=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=b);const p="imageProcessingDeclaration",U=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=U);const m="imageProcessingFunctions",W=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=W);const g="bumpFragmentMainFunctions",H=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=H);const S="bumpFragmentFunctions",z=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=z);const E="bumpFragment",V=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=V);const C="decalFragment",G=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=G);const D="depthPrePass",B=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=B);const L="lightFragment",k=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=k);const T="oitFragment",Y=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=Y);const i="defaultPixelShader",I=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=I);const j={name:i,shader:I};export{j as defaultPixelShader};
//# sourceMappingURL=default.fragment-BTi9a3gE.js.map
