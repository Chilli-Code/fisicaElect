import{S as e}from"./main.mobile-B9PiUoMa.js";const o="meshUboDeclaration",a=`#ifdef WEBGL2
...
#endif
#define WORLD_UBO
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=a);const i="defaultUboDeclaration",r=`layout(std140,column_major) uniform;uniform Material
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=r);const t="mainUVVaryingDeclaration",c=`#ifdef MAINUV{X}
varying vec2 vMainUV{X};
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=c);
//# sourceMappingURL=mainUVVaryingDeclaration-1uLWd6eo.js.map
